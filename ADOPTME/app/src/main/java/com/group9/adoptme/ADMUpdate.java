...
public class ADMUpdate extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = ADMUpdate.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adm_update);
        ...
        btn_updateMeal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ADMUpdate.this);
                alertDialogBuilder.setTitle("Update Pet");
                alertDialogBuilder.setMessage("Continue updating your pet?");
        ...
        btn_selectmeal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(ADMUpdate.this)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOADMEALIMG,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            progressDialog.dismiss();
                            Toast.makeText(ADMUpdate.this, "Error Reading Details "+ e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener(){
                    ...
                    public void onErrorResponse(VolleyError error){
                        progressDialog.dismiss();
                        Toast.makeText(ADMUpdate.this, "Error Reading Details "+ error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("petPhoto",mealPhoto);
                params.put("petID", mealID);
                return params;
            }
        };
    ...
    private void UpdateMeal() {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            String success = jsonObject.getString("success");
                            if(success.equals("1")){
                                Toast.makeText(ADMUpdate.this, "Update Successful", Toast.LENGTH_SHORT).show();
                                clearFields();
                                progressDialog.dismiss();
                                Intent mh_timeline = new Intent(ADMUpdate.this, ADMTimeline.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(ADMUpdate.this, "Update Failed!\n"+ e.toString(), Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        }
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> params = new HashMap<>();
                params.put("petName", mealName);
                params.put("petCategory", mealCategory);
                //params.put("mealPhoto", mealPhoto);
                params.put("petProcedure", mealProcedure);
                params.put("petID", data_mealID);
                return params;
            }
        };
        RequestQueue requestQueue = Volley.newRequestQueue(this);
    ...
    public void onBackPressed(){
        ...
        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface arg0, int arg1) {
                Intent b = new Intent(ADMUpdate.this, AdMDashboard.class );
                startActivity(b);
                finish();
            }
        });
