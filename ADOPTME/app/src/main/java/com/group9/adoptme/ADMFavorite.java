...
public class ADMFavorite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adm_favorite);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, COUNTFAV+setUser,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            int totalFav = petObject.getInt("totalFav");
                            String fav = String.valueOf(totalFav);
                            counFav.setText("You have added "+ fav +" pets on your collection.");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ADMFavorite.this, "Error!\n"+ error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i=0; i<dashPet.length();i++){
                                ...
                                String favValue = petObject.getString("favValue");
                                String petID = petObject.getString("petID");

                                UsersFavorite usersFavorite = new UsersFavorite(userphoto, fullname, petDate, petName, petPhoto, favValue, petID);
                                usersFavoriteList.add(usersFavorite);
                            }
                            adapter = new AdapterFavorite(ADMFavorite.this, usersFavoriteList, onclickInterface);
    ...
    public void onBackPressed(){
        ...
        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent b = new Intent(ADMFavorite.this, AdMDashboard.class );
                startActivity(b);
                finish();
            }
        });
