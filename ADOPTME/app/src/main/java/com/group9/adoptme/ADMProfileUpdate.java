...
public class ADMProfileUpdate extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = ADMProfileUpdate.class.getSimpleName();
    ...
    private static String URL_READ = "https://groupadoptme.000webhostapp.com/AdoptMe/read_detail.php";
    private static String URL_EDIT = "https://groupadoptme.000webhostapp.com/AdoptMe/edit_detail.php";
    private static String URL_UPLOAD = "https://groupadoptme.000webhostapp.com/AdoptMe/upload.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adm_profile_update);
        ...
        button_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(ADMProfileUpdate.this)
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(success.equals("1")){
                        ...
                        for(int i= 0; i < jsonArray.length(); i++){
                            ...
                            if (d_userphoto != null){
                                Glide.with(ADMProfileUpdate.this)
                    ...
                    e.printStackTrace();
                    progressDialog.dismiss();
                    Toast.makeText(ADMProfileUpdate.this, "Error Reading Detail "+ e.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        },
                new Response.ErrorListener(){
                    ...
                    public void onErrorResponse(VolleyError error){
                        progressDialog.dismiss();
                        Toast.makeText(ADMProfileUpdate.this, "Error Reading Detail "+ error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success.equals("1")){
                                ...
                                Intent adm_profile = new Intent(ADMProfileUpdate.this, ADMProfile.class);
                                startActivity(adm_profile);
                            }
                        }
                        catch(JSONException e){
                            e.printStackTrace();
    ...
    public void onBackPressed(){
        ...
        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent b= new Intent(ADMProfileUpdate.this, ADMProfile.class );
                startActivity(b);
                finish();
            }
        });
